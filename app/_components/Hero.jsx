    ...
    <section className="pt-20">
      ...
      <div className="relative bg-gradient-to-r from-[#5C5CFF] to-[#2E2EFF] py-20">
        <div className="flex flex-col xl:flex-row items-center justify-between 2xl:px-64 px-6">
          <div className="w-full xl:w-1/2 text-center xl:text-left text-white">
            ...
            <Link href={'/sign-up'}>
              <Button className="bg-white text-primary font-semibold text-base py-3 px-8 rounded-md shadow-lg hover:bg-opacity-90 transition duration-300 ease-in-out hover:text-white">
          ...
          <div className="w-full xl:w-1/2 mt-10 xl:mt-0">
            <img
              src="/hero.webp"
              alt="hero image"
              className="w-full h-auto rounded-md shadow-2xl transform hover:scale-105 transition duration-500 ease-in-out"
            />
          </div>
        </div>
      </div>
      ...
      <div className="bg-gray-50 py-16">
        <div className="text-center">
          ...
          <p className="text-base sm:text-lg text-gray-600 opacity-80 mb-8">
        ...
        <div className="flex flex-wrap justify-center gap-8">
          ...
          <div className="w-full sm:w-1/2 md:w-1/3">
            <div className="p-6 border rounded-md shadow-lg hover:shadow-xl transition duration-300 ease-in-out">
              <Image
                src="/dashboard.jpg"
                width={400}
                height={250}
      ...
      <div className="bg-primary text-white py-16 text-center">
        ...
        <Link href={'/sign-up'}>
          <Button className="bg-white text-primary font-semibold text-lg py-3 px-8 rounded-md shadow-lg hover:bg-opacity-90 transition duration-300 ease-in-out hover:text-white">
            Get Started
          </Button>
        </Link>
      </div>
      ...
      {/* Testimonial Slider */}
      <div className="bg-gray-100 py-16 border">
        <div className="text-center mb-12">
          <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-800 mb-6">
            What Our Users Are Saying
          </h2>
          <p className="text-base sm:text-lg text-gray-600 opacity-80">
            Hear from our users about how the app has helped them manage their
            finances better.
          </p>
        </div>

        <div className="max-w-3xl mx-auto border rounded-md bg-slate-50">
          <Slider {...sliderSettings}>
            ...
            <div className="text-center p-8">
              ...
              <p className="text-lg font-semibold text-gray-800">Robin</p>
            ...
            <div className="text-center p-8">
              <p className="text-xl text-gray-600 mb-4">
                ...
                simplicity and ease of use that this one does. Highly recommend!"
              </p>
              <p className="text-lg font-semibold text-gray-800">Arif</p>
            ...
            <div className="text-center p-8">
              ...
              <p className="text-lg font-semibold text-gray-800">Rasel</p>
