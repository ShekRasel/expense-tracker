    ...
    <div className="min-h-screen bg-gradient-to-r from-blue-50 to-gray-100 flex items-center justify-center px-4 lg:px-8">
      ...
      <div className="flex items-stretch bg-white rounded-2xl shadow-xl overflow-hidden w-full max-w-4xl">
        ...
        <div className="hidden lg:flex flex-col items-center justify-center w-1/2 bg-blue-600 p-8 text-white">
          ...
          />
          <h1 className="text-4xl font-bold mb-4 text-center">Welcome to Expense Tracker</h1>
          <p className="text-lg text-center">
            Take control of your finances with our easy-to-use expense tracker app. Sign up now to
